      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="bg-secondary-dark hover:bg-primary-accent p-3 rounded-lg transition-colors duration-200"
                aria-label="LinkedIn"
              >
            ...
            <ul className="space-y-3">
              <li>
                <button 
                  ...
                  className="text-gray-300 hover:text-primary-accent transition-colors duration-200"
                >
                  Services
                </button>
              </li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <button
              onClick={scrollToTop}
              className="bg-secondary-dark hover:bg-primary-accent p-2 rounded-lg transition-colors duration-200 group"
